// DDL completo do FutsalMoz 258.
// É executado automaticamente na primeira utilização (CREATE TABLE IF NOT EXISTS),
// pelo que não é necessário correr SQL manual no Neon.
// (init.sql contém o mesmo conteúdo, apenas para referência.)
